        ...
        {selectedUser && (
          ...
          >
            ...
            >
              ...
              {/* Profile Info */}
              <div className="px-4 pb-4 pt-4 overflow-y-auto flex-1">
                {/* Avatar + Name Row */}
                  ...
                  <div className="w-14 h-14 shrink-0">
                    {userStats?.user?.avatarUrl ? (
                      <img 
                        ...
                        className="w-14 h-14 rounded-xl object-cover shadow-lg border-2 border-white/10"
                      />
                    ) : (
                      <div 
                        className="w-14 h-14 rounded-xl flex items-center justify-center text-xl font-bold shadow-lg border-2 border-white/10"
                        style={{ 
