...
export default function Casino() {
  ...
  return (
    <MainLayout>
      ...
      <div className="flex gap-3 mb-10 overflow-x-auto pb-4 scrollbar-none snap-x px-1 md:justify-center">
          <Link href="/games/mines" className="snap-start flex-shrink-0">
          ...
          <Link href="/games/double" className="snap-start flex-shrink-0">
          ...
          <Link href="/games/aviatormania" className="snap-start flex-shrink-0">
          ...
          <Link href="/games/plinko" className="snap-start flex-shrink-0">
          ...
          <Link href="/vip" className="snap-start flex-shrink-0">
