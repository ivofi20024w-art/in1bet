...
import { ArrowLeft, Bell, Globe, Percent, Sliders, Moon, Smartphone } from "lucide-react";
        ...
        <div className="space-y-6">
            <Card className="bg-card border-white/5 shadow-lg">
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <RadioGroup defaultValue="decimal" className="grid grid-cols-3 gap-4">
                            <div>
            ...
            <Card className="bg-card border-white/5 shadow-lg opacity-50 pointer-events-none">
             ...
             <div className="flex justify-end pt-4">
                <Button className="bg-primary hover:bg-primary/90 text-white font-bold h-12 px-8 shadow-lg shadow-primary/20">Salvar Alterações</Button>
            </div>
        </div>
      </div>
    </MainLayout>
